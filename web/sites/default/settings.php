 ...
 */
$settings['container_yamls'][] = $app_root . '/' . $site_path . '/sites/development.services.yml';
...
$settings['config_sync_directory'] = $app_root . '/../config_sync/sync';
